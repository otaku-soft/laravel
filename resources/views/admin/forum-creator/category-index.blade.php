...
<script>
    ...
    $("#addCategoryForm").on("submit", function (event)
    {
        ...
        $.post("{{ route('forumCreator_addCategory') }}", $(this).serializeArray()).done(function (data)
        {
            window.location = "";
        });
    });
    ...
    function saveOrder()
    {
        ...
        $.post("{{ route('forumCreator_orderCategories') }}", {
            ids: ids,
    ...
    {
        $.post("{{ route('forumCreator_editCategoryModal') }}", {id: id}).done(function (data)
        {
    ...
    {
        $.post("{{ route('forumCreator_deleteCategoryModal') }}", {id: id}).done(function (data)
        {
